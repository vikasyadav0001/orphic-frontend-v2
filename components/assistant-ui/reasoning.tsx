...
const reasoningVariants = cva("aui-reasoning-root mb-1.5 w-full", {
  variants: {
    variant: {
...
function ReasoningText({
  ...
  return (
    <div
      ...
      className={cn(
        "aui-reasoning-text relative z-0 min-h-14 max-h-64 overflow-y-auto ps-6 pt-4 pb-4 leading-relaxed text-pretty",
